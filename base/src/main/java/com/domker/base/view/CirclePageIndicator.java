...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    private final PagerChangedListener mPagerChangedListener = new PagerChangedListener();
...
//        }
        ...
        mViewPager = view;
        mViewPager.registerOnPageChangeCallback(mPagerChangedListener);
        invalidate();
    }
    ...
    class PagerChangedListener extends ViewPager2.OnPageChangeCallback {
        @Override
